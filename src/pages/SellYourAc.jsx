    ...
    <div>
      ...
      >
        <div className="container">
          ...
          >
            Fill in a few details, set your price, and start getting offers from
            verified buyers — 100% free.
          </p>
        </div>
      </section>
            ...
            <form id="sell-listing-form" onSubmit={handleSubmit} novalidate>
              ...
              >
                <FormInput
                  ...
                  id="sell-brand"
                  name="brand"
                  placeholder="e.g. LG, Daikin, Samsung"
                ...
                <FormInput
                  ...
                  id="sell-model"
                  name="model"
                  placeholder="e.g. LG Window 1.5 Ton"
              ...
              <div className="mt-4">
                <FormTextarea
                  ...
                  id="sell-description"
                  name="description"
                  placeholder="Describe the unit — its condition, any features or faults, how long you've owned it, reason for selling…"
              ...
              >
                ...
                ></i>
                <p className={clsx("text-sm", "text-text-muted")}>
                  Click to upload photos of your unit
                </p>
                <span
                  className={clsx(
                    "text-xs",
                ...
                >
                  JPEG or PNG · Max 5 MB each · Up to 6 photos
                </span>
                <input
                  type="file"
                  id="sell-photos"
              ...
              >
                <i
                  className={clsx("fa-solid", "fa-tag", "text-accent", "mr-2")}
                ></i>
                Pricing & Location
              </h2>
              ...
              >
                <div className="form-group">
                  ...
                  >
                    Asking Price (GHC) <span className="text-red-500">*</span>
                  </label>
                  <div className={clsx("price-prefix-group", "relative")}>
                    ...
                    <input
                      ...
                      min="0"
                      className={
                        "w-full pl-13 px-3 py-2 border border-border rounded-lg font-body text-sm text-text bg-(--color-bg) outline-none " +
                        (errors.price
                          ? "border-red-500"
                          : "focus:border-accent focus:shadow-[0_0_0_3px_rgba(255,122,69,0.12)]")
                      }
                    />
                  </div>
                  {errors.price && (
              ...
              <div className={clsx("form-submit-area", "mt-8", "text-center")}>
                <Button
                  type="submit"
                  variant="accent"
                  className={clsx("min-w-55", "px-8", "py-4", "text-base")}
                >
              ...
              {submitted && (
                ...
                >
                  ...
                  ></i>
                  Your listing has been submitted! Our team will review it and
                  it'll go live shortly.
                  <br />
                  <a
                    href="/buy"
                    className={clsx(
