    ...
    <div>
      ...
      <section
        className={clsx(
          ...
          "overflow-hidden",
          "relative",
          "bg-[url(assets/images/bakgroundhome.jpg)]",
          'bg-cover',
          'bg-center'
        )}
      >
        <div className="absolute inset-0 bg-linear-to-b from-black/70 to-black/50"></div>
        <div
          className={clsx(
            "container",
            "hero-inner",
        ...
        >
          <div className="hero-text">
            <p className="eyebrow">
              Best Enterprise's marketplace for air conditioners
            </p>
            <h1
              className={clsx(
                "text-[2.75rem]",
            ...
            >
              Browse verified new & used air conditioners near you, or list your
              old unit in minutes and start getting offers today.
            </p>
            ...
            >
              ...
              <button
                type="submit"
                className={clsx("btn", "btn-primary", "whitespace-nowrap")}
              >
                Search
              </button>
            </form>
            ...
            >
              ...
              <Button to="/sell-your-ac" variant="outline">
                List Your AC — It's Free
              </Button>
            </div>
          </div>
            ...
            <div className={clsx("gauge", "relative", "w-70", "h-70")}>
              <div
                className={clsx(
                  ...
                  "h-full",
                  "rounded-full",
                  "bg-conic-[from_270deg,var(--color-primary)_0deg_180deg,var(--color-accent)_180deg_360deg]",
                  "shadow-[0_20px_45px_rgba(14,134,212,0.25)]",
                  "flex",
                  "items-center",
                  "justify-center",
                  "relative",
              ...
              <div
                className={clsx(
                  ...
                  "top-1/2",
                  "-translate-y-1/2",
                  "-left-2.5dark:text-white",
                  "font-heading",
                  "font-semibold",
                  "text-[0.85rem]",
                  "text-surface",
                  "bg-[rgba(16,36,62,0.55)]",
                  "px-3",
                  "py-1",
                  "rounded-full",
                  "flex",
      ...
      {/* Stats strip */}
      <section
        className={clsx("stats-strip", "bg-primary", "py-8.5")}
        ref={statsRef}
      >
        <div
          className={
            "container stats-grid grid grid-cols-4 text-center transition-all duration-700 " +
            (statsVisible
      ...
      <section className="section" id="categories" ref={catsRef}>
        <div className="container">
          <SectionHeading
            ...
            title="Find the right unit for your space"
          />
          <div
            className={
              "category-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 transition-all duration-700 " +
              (catsVisible
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-6")
            }
